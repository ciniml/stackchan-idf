...
// Proximity sensor live reading for BLE chr 0x30 (CoreS3 LTR-553). Plain
// function pointer (no allocation on the NimBLE host task).
...
using ProximityStatusGetter = ProximityStatus (*)();
